...
import lt.rimkus.payments.service.impl.NotificationServiceTwoImpl;
...
class NotificationServiceTwoImplTest {
    ...
    private NotificationServiceTwoImpl notificationService;
    ...
    void setUp() {
        ...
        notificationService = new NotificationServiceTwoImpl(restTemplateBuilder, TEST_URL);
    }
    ...
    void givenDefaultConstructorValues_whenServiceCreated_thenShouldUseDefaultUrl() {
        ...
        NotificationServiceTwo serviceWithDefault = new NotificationServiceTwoImpl(restTemplateBuilder, "https://api.github.com/users/");
