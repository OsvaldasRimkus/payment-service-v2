...
class NotificationServiceOneImplTest {
    ...
    private NotificationServiceOneImpl notificationService;
    ...
    void setUp() {
        ...
        notificationService = new NotificationServiceOneImpl(restTemplateBuilder, TEST_URL);
    }
    ...
    void givenDefaultConstructorValues_whenServiceCreated_thenShouldUseDefaultUrl() {
        ...
        NotificationServiceOne serviceWithDefault = new NotificationServiceOneImpl(restTemplateBuilder, "https://api.github.com/users/");
