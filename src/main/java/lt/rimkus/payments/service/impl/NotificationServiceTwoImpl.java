...
@Service
public class NotificationServiceTwoImpl implements NotificationServiceTwo {
    private static final Logger logger = LoggerFactory.getLogger(NotificationServiceOne.class);

    private final RestTemplate restTemplate;
    private final String notificationServiceUrl;

    public NotificationServiceTwoImpl(RestTemplateBuilder restTemplateBuilder, @Value("${app.geo.service.url:https://api.github.com/users/}") String notificationServiceUrl) {
